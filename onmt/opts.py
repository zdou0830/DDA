...
def train_opts(parser):
    ...
    group.add_argument('-lm_multi', action="store_true",
                       help='When available, train to copy.')
    group.add_argument('-lm_guide', action="store_true",
                       help='When available, train to copy.')
    group.add_argument('-lm_deep_fusion', action="store_true",
                       help='When available, train to copy.')
    group.add_argument('-just_adapt_weight', action="store_true",
                       help='When available, train to copy.')
    group.add_argument('-lm_my_deep_fusion', action="store_true",
                       help='When available, train to copy.')
    group.add_argument('-lm_fuse_embedding', action="store_true",
                       help='When available, train to copy.')
    group.add_argument('-lm_fuse_hidden', action="store_true",
                       help='When available, train to copy.')
...
def translate_opts(parser):
    ...
    group.add_argument('-lm_fuse_embedding', action="store_true",
                       help='When available, train to copy.')
    group.add_argument('-lm_fuse_generator', action="store_true",
                       help='When available, train to copy.')
    group.add_argument('-lm_fuse_hidden', action="store_true",
                       help='When available, train to copy.')
    group.add_argument('-lm_bias', action="store_true",
                       help='When available, train to copy.')
    group.add_argument('-lm_path',type=str,
                       help='When available, train to copy.')
    group.add_argument('-lm_out_path',type=str,
                       help='When available, train to copy.')
    group.add_argument('-second_model_path',type=str,
                       help='When available, train to copy.')
    group.add_argument('-lm_out', default="",
                       help="Source directory for image or audio files.")
    group.add_argument('-lm_in', default="",
    ...
    group.add_argument('-beam_size', type=int, default=5,
                       help='Beam size')
    group.add_argument('-bias_param', type=float, default=0,
                       help='Beam size')
