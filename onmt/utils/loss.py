...
def build_loss_compute(model, tgt_vocab, opt, train=True):
    ...
    elif opt.lm_fuse_generator:
        compute = LMDFNMTLossCompute(
            model.generator, model.lm_in_generator, model.lm_out_generator, model.generator_out1, model.generator_out2, model.generator_out3, tgt_vocab,
